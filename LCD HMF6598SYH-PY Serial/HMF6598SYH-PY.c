...
#define HMF6598_RES   pin_B6
#define HMF6598_CS1   pin_B5
#define HMF6598_RS    pin_B4
#define HMF6598_WR    pin_B3
#define HMF6598_RD    pin_B2
#define HMF6598_CLK   pin_B1
#define HMF6598_DATA  pin_B0
...
void HMF6598_OutPort(char byteDC){
  ...
  //output_b(byteDC);
  for (i=8; i>0; i--) {
    output_low(HMF6598_CLK);
    if ((byteDC&0x80)==0)
      output_low(HMF6598_DATA);
    else
      output_high(HMF6598_DATA);
    output_high(HMF6598_CLK);
    byteDC<<=0x01;
  }
