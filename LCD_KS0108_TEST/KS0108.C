...
#ifndef KS0108_CS
#define KS0108_CS             PIN_A0   // Chip select
#endif
#ifndef KS0108_DI                      //      ___________
#define KS0108_DI             PIN_A1   // Data/Instruction
#endif

#ifndef KS0108_RW                      //      _____
#define KS0108_RW             PIN_A2   // Read/Write
#endif

#ifndef KS0108_E
#define KS0108_E              PIN_A3   // Enable
#endif

#ifndef KS0108_RST
#define KS0108_RST            PIN_A4   // Reset
#endif
...
void KS0108_write(int8 data)
{
   ...
   output_b(data);            // Write to the data bus
   delay_cycles(2);
...
int8 KS0108_read()
{
   ...
   delay_cycles(10);
   data = input_b();          // Read from the data bus
